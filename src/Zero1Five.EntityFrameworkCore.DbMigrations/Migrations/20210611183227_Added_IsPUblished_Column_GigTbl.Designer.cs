...
namespace Zero1Five.Migrations
{
    ...
    [Migration("20210611183227_Added_IsPUblished_Column_GigTbl")]
    partial class Added_IsPUblished_Column_GigTbl
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Zero1Five.Categories.Category", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Zero1Five.Gigs.Gig", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Zero1Five.Products.Product", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Zero1Five.Products.Product", b =>
                {
                    b.HasOne("Zero1Five.Categories.Category", null)
                        .WithMany()
                        .HasForeignKey("CategoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Zero1Five.Gigs.Gig", null)
                        .WithMany("Products")
                        .HasForeignKey("GigId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
